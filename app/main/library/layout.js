...
export default function LibraryLayout({ children }) {
  ...
  return (
    <div className="flex flex-row bg-white dark:bg-[#000] h-screen w-[100%]">
      {/* chats */}
      <div className="h-[100vh] pn:max-md:h-[100vh] select-none pn:max-md:w-[100%] w-[100%] flex flex-col items-start  md:border-r-2 border-[#f7f7f7] overflow-auto scrollbar-hide ">
        {/* header */}
        <div className="md:h-[100px] py-2 border-b-[1px] dark:bg-[#171717] dark:border-[#3e3e3e] dark:border-r-2 dark:text-[#fff] bg-white pn:max-sm:fixed top-14 md:min-w-[390px] md:[360px] pn:max-md:w-[100%] flex flex-col pn:max-md:z-10">
          <div
